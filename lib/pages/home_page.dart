...
focusNode: ,
                              onSubmitted: (value) {
                                setState(() {
                                  _selectedArr = value.toString();
                                  _arrivalSearchController.closeView(value);
                                  FocusScope.of(context).unfocus();
                                });
                              },
                            );
...
//TODO: 실시간 시간표, 없는 역 검색 시, 역 아닌 것 검색 시,
//TODO: ... 정보 SharedPreference->즐겨찾기, 검색기록, 타임테이블, 신고
//TODO: 최소환승
